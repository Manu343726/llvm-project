...
void FantasyTargetObjectFile::Initialize(MCContext &Ctx,
...
// section.
bool FantasyTargetObjectFile::isGlobalInSmallSection(
...
// Return true if this global address should be placed into small data/bss
// section.
bool FantasyTargetObjectFile::isGlobalInSmallSection(const GlobalObject *GO,
                                                     const TargetMachine &TM,
...
// kind.
bool FantasyTargetObjectFile::isGlobalInSmallSectionImpl(
    const GlobalObject *GO, const TargetMachine &TM) const {
...
MCSection *FantasyTargetObjectFile::SelectSectionForGlobal(
...
bool FantasyTargetObjectFile::isConstantInSmallSection(
    const DataLayout &DL, const Constant *CN) const {
  return isInSmallSection(DL.getTypeAllocSize(CN->getType()));
}

MCSection *FantasyTargetObjectFile::getSectionForConstant(
