...
static MCDisassembler *createFantasyDisassembler(const Target & /*T*/,
                                                 const MCSubtargetInfo &STI,
                                                 MCContext &Ctx) {
  return new FantasyDisassembler(STI, Ctx);
}

extern "C" LLVM_EXTERNAL_VISIBILITY void LLVMInitializeFantasyDisassembler() {
  // Register the disassembler
  TargetRegistry::RegisterMCDisassembler(getTheFantasyTarget(),
                                         createFantasyDisassembler);
}

FantasyDisassembler::FantasyDisassembler(const MCSubtargetInfo &STI,
                                         MCContext &Ctx)
...
#include "FantasyGenDisassemblerTables.inc"
  ...
  if (PqShift != -1) {
    ...
    case 0x0:
      if (Instr.getOperand(2).isReg()) {
        Instr.getOperand(2).setReg(Fantasy::R0);
      }
...
DecodeStatus
FantasyDisassembler::getInstruction(MCInst &Instr, uint64_t &Size,
  ...
  Result =
      decodeInstruction(DecoderTableFantasy32, Instr, Insn, Address, this, STI);
...
static const unsigned GPRDecoderTable[] = {
    Fantasy::R0,  Fantasy::R1,  Fantasy::PC,  Fantasy::R3,  Fantasy::SP,
    Fantasy::FP,  Fantasy::R6,  Fantasy::R7,  Fantasy::RV,  Fantasy::R9,
    Fantasy::RR1, Fantasy::RR2, Fantasy::R12, Fantasy::R13, Fantasy::R14,
    Fantasy::RCA, Fantasy::R16, Fantasy::R17, Fantasy::R18, Fantasy::R19,
    Fantasy::R20, Fantasy::R21, Fantasy::R22, Fantasy::R23, Fantasy::R24,
    Fantasy::R25, Fantasy::R26, Fantasy::R27, Fantasy::R28, Fantasy::R29,
    Fantasy::R30, Fantasy::R31};
