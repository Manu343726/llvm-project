//===-- FantasyISelLowering.h - Fantasy DAG Lowering Interface -....-*- C++
//-*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the interfaces that Fantasy uses to lower LLVM code into a
// selection DAG.
//
//===----------------------------------------------------------------------===//
...
class FantasyTargetLowering : public TargetLowering {
public:
  FantasyTargetLowering(const TargetMachine &TM, const FantasySubtarget &STI);
