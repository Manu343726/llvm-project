//===-- FantasyFixupKinds.h - Fantasy Specific Fixup Entries --------*- C++
//-*-===//
//
...
// MCFixupKindInfo Infos[Fantasy::NumTargetFixupKinds]
// in FantasyAsmBackend.cpp.
//
enum Fixups {
  // Results in R_Fantasy_NONE
