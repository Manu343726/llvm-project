//= FantasyInstPrinter.h - Convert Fantasy MCInst to asm syntax -------*- C++
//-*--//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints a Fantasy MCInst to a .s file.
//
//===----------------------------------------------------------------------===//
...
class FantasyInstPrinter : public MCInstPrinter {
public:
  FantasyInstPrinter(const MCAsmInfo &MAI, const MCInstrInfo &MII,
