//===-- FantasyMCAsmInfo.cpp - Fantasy asm properties
//-----------------------===//
//
...
//===----------------------------------------------------------------------===//
//
// This file contains the declarations of the FantasyMCAsmInfo properties.
//
//===----------------------------------------------------------------------===//
...
void FantasyMCAsmInfo::anchor() {}

FantasyMCAsmInfo::FantasyMCAsmInfo(const Triple & /*TheTriple*/,
  ...
  // Fantasy assembly requires ".section" before ".bss"
