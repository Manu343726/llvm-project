//===-- FantasyAluCode.h - ALU operator encoding
//----------------------------===//
//
...
const int Fantasy_PRE_OP = 0x40;
const int Fantasy_POST_OP = 0x80;

inline static unsigned encodeFantasyAluCode(unsigned AluOp) {
...
inline static AluCode stringToFantasyAluCode(StringRef S) {
...
inline static AluCode isdToFantasyAluCode(ISD::NodeType Node_type) {
  switch (Node_type) {
  case ISD::ADD:
    return AluCode::ADD;
  case ISD::ADDE:
