//===------- CucarachaTargetObjectFile.cpp - Cucaracha Object Info Impl
//-----------===//
//
...
void CucarachaELFTargetObjectFile::Initialize(MCContext &Ctx,
                                              const TargetMachine &TM) {
  TargetLoweringObjectFileELF::Initialize(Ctx, TM);
}

const MCExpr *CucarachaELFTargetObjectFile::getTTypeGlobalReference(
