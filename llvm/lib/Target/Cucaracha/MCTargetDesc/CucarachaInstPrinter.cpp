...
void CucarachaInstPrinter::printRegName(raw_ostream &OS,
                                        MCRegister RegNo) const {
...
void CucarachaInstPrinter::printCondCode(const MCInst *MI, unsigned OpNum,
                                         const MCSubtargetInfo &STI,
                                         raw_ostream &O) {
...
void CucarachaInstPrinter::printAddrModeMemSrc(const MCInst *MI, unsigned OpNum,
                                               const MCSubtargetInfo &STI,
                                               raw_ostream &O) {
...
void CucarachaInstPrinter::printOperand(const MCInst *MI, unsigned OpNo,
                                        const MCSubtargetInfo &STI,
                                        raw_ostream &O) {
