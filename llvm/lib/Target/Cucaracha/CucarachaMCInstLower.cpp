...
//===----------------------------------------------------------------------===//
//
// This file contains code to lower Cucaracha MachineInstrs to their
...
static MCOperand LowerSymbolOperand(const MachineInstr *MI,
  ...
  const CucarachaMCExpr *expr =
      CucarachaMCExpr::create(Kind, MCSym, AP.OutContext);
...
void llvm::LowerCucarachaMachineInstrToMCInst(const MachineInstr *MI,
