...
#define DEBUG_TYPE "cucaracha-isel"
#define PASS_NAME "Cucaracha DAG->DAG Pattern Instruction Selection"
...
class CucarachaDAGToDAGISel : public SelectionDAGISel {
  /// Subtarget - Keep a pointer to the Cucaracha Subtarget around so that we
...
INITIALIZE_PASS(CucarachaDAGToDAGISel, DEBUG_TYPE, PASS_NAME, false, false)

SDNode *CucarachaDAGToDAGISel::getGlobalBaseReg() {
...
bool CucarachaDAGToDAGISel::SelectADDRri(SDValue Addr, SDValue &Base,
                                         SDValue &Offset) {
...
bool CucarachaDAGToDAGISel::SelectADDRrr(SDValue Addr, SDValue &R1,
                                         SDValue &R2) {
...
bool CucarachaDAGToDAGISel::tryInlineAsm(SDNode *N) {
...
/// SelectInlineAsmMemoryOperand - Implement addressing mode selection for
/// inline asm expressions.
bool CucarachaDAGToDAGISel::SelectInlineAsmMemoryOperand(
...
FunctionPass *llvm::createCucarachaISelDag(CucarachaTargetMachine &TM) {
  return new CucarachaDAGToDAGISel(TM);
}
