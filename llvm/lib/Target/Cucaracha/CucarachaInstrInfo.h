...
#ifndef LLVM_LIB_TARGET_Cucaracha_CucarachaINSTRINFO_H
#define LLVM_LIB_TARGET_Cucaracha_CucarachaINSTRINFO_H
...
class CucarachaInstrInfo : public CucarachaGenInstrInfo {
  const CucarachaRegisterInfo RI;
  const CucarachaSubtarget &Subtarget;
  virtual void anchor();

public:
  explicit CucarachaInstrInfo(CucarachaSubtarget &ST);
