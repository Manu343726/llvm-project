//===-- DelaySlotFiller.cpp - Cucaracha delay slot filler
//---------------------===//
//
...
static cl::opt<bool>
    DisableDelaySlotFiller("disable-cucaracha-delay-filler", cl::init(false),
                           cl::desc("Disable the Cucaracha delay slot filler."),
                           cl::Hidden);

namespace {
struct Filler : public MachineFunctionPass {
  const CucarachaSubtarget *Subtarget = nullptr;

  static char ID;
  Filler() : MachineFunctionPass(ID) {}

  StringRef getPassName() const override {
    return "Cucaracha Delay Slot Filler";
  }

  bool runOnMachineBasicBlock(MachineBasicBlock &MBB);
  bool runOnMachineFunction(MachineFunction &F) override {
    bool Changed = false;
    Subtarget = &F.getSubtarget<CucarachaSubtarget>();
...
/// createCucarachaDelaySlotFillerPass - Returns a pass that fills in delay
/// slots in Cucaracha MachineFunctions
///
FunctionPass *llvm::createCucarachaDelaySlotFillerPass() { return new Filler; }
...
bool Filler::runOnMachineBasicBlock(MachineBasicBlock &MBB) {
  bool Changed = false;
  Subtarget = &MBB.getParent()->getSubtarget<CucarachaSubtarget>();
