...
#ifndef LLVM_LIB_TARGET_Cucaracha_CucarachaISELLOWERING_H
#define LLVM_LIB_TARGET_Cucaracha_CucarachaISELLOWERING_H
...
public:
  CucarachaTargetLowering(const TargetMachine &TM,
...
#endif // Cucaracha_ISELLOWERING_H
